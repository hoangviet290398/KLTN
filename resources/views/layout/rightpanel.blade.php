    ...
    <div>
        ...
        <div class="row px-2 pt-1 pb-1">
            ...
            <div class="col-sm-3">
                ...
                <a href="/personalinfomation/{{ $topMember->_id }}" class="text-decoration-none"><img
                        src="{{ asset('storage/avatars')}}/{{$topMember->avatar}}"
            ...
            <div class="col-sm-3">
                ...
                <a href="/personalinfomation/{{ $topMember->_id }}" class="text-decoration-none"><img
                        src="{{$topMember->avatar}}" class="img-fluid rounded-circle align-middle user-avatar"></a>
            </div>
            @endif
            <br />
            ...
            <div class="col-sm-9">
                ...
                <div class="row">
                    <small class="text-dark  pr-2" style="color:#5488c7;">
                        <strong>{{$topMember->reputation_score}} danh tiếng</strong>
                    </small>
            ...
            <div class="row">
                <div class="pl-2 py-2">
                    <a href="{{ route('viewByCategory', ['id' => $category->id]) }}"
                        class="border text-primary p-1 bg-light rounded ">
                        {{$category->name}}
                    </a>
