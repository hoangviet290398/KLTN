    ...
    <div id="chat-box" class="px-4 py-5 chat-box bg-white">
      ...
      <form action="#" class="bg-light">
        <div class="input-group">
          <input id="typing-area" type="text" placeholder="Type a message" aria-describedby="button-addon2" autofocus class="form-control rounded-0 border-0 py-4 bg-light">
