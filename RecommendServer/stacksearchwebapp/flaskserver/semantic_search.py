...
data = pd.read_csv('/app/flaskapi/data/Preprocessed_data.csv')
all_title_embeddings = pd.read_csv('/app/flaskapi/models/title_embeddings.csv').values

# Import saved Wordvec Embeddings
w2v_model = gensim.models.word2vec.Word2Vec.load('/app/flaskapi/models/SO_word2vec_embeddings.bin')
